...
class Alien:
    ...
    def draw(self):
        pygame.draw.rect(self.game.screen, PURPLE, pygame.Rect(self.x, self.y, self.size, self.size))
        self.y = self.y + 0.1
...
class Hero:
    ...
    def draw(self):
        pygame.draw.rect(self.game.screen, WHITE, pygame.Rect(self.x, self.y, 8, 5))
